...
# Local
from supervoice_hybrid import SupervoiceVariant3, SentencePieceTextTokenizer
...
train_lr_max = 5e-5
train_steps = 60000
train_warmup_steps = 1000 # I am using faster warmup - it is more natural for me after working on voicebox
train_sigma = 1e-5
...
def create_model():
    ...
    return SupervoiceVariant3(flow)
